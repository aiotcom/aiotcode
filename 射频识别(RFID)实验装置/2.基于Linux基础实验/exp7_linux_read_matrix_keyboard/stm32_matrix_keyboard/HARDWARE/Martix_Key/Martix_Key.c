...
_KeyMap KeyValue2Command[]={
    ...
    {KEY_8,Matrixkey8},
    {KEY_9,Matrixkey9},
    {KEY_ENTER,MatrixkeyEnter},
    {KEY_CANNCEL,MatrixkeyCanel},
    {KEY_UP,MatrixkeyUP},
    {KEY_DOWN,MatrixkeyDown},
    {KEY_RIGHT,MatrixkeyRight},
    {KEY_LEFT,MatrixkeyLeft},    
};
...
//	说明：		
//==========================================================
uint16_t FindKeyValue2Command(uint8_t r)
{
    uint8_t i=0,ret;
    while(i<16)
    {
        if(r == KeyValue2Command[i].kr)
        {
            ret =  KeyMap[i].kv;
        }
        i++;
