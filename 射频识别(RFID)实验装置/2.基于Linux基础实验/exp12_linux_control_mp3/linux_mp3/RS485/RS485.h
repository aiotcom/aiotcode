...
#define         Addr_Linux                      0x3601          //linux底座
#define         Addr_NFC                        0x3701          //linux底座
/*		命令码		*/
...
#define         Addr_UHF_RFID                     0x3801             //NFC模块
...
#define			MP3_Start_Pause				    0x2A11		//MP3-开始播放
#define			MP3_Stop							0x2A21		//MP3-暂停播放
#define			MP3_Cycle1						0x2A31		//MP3-单曲不循环播放
#define			MP3_Cycle2						0x2A32		//MP3-单曲循环播放
#define			MP3_Cycle3						0x2A33		//MP3-所有曲目循环播放
#define			MP3_Cycle4						0x2A34		//MP3-随机播放
#define			MP3_Reduce_volume			0x2A40		//MP3-音量减小
#define			MP3_Add_volume				0x2A41		//MP3-音量增加
#define			MP3_Last_Song					0x2A51		//MP3-上一曲
#define			MP3_Next_Song					0x2A61		//MP3-下一曲
#define			MP3_Target					0x2A62		//MP3-下一曲
...
#define			NFC_DATA					0x3440		//手势传感器-靠近
#define			UHF_DATA					0x3450		//UHF Data
...
extern void Rs485_Send(int fd,uint16_t SrcAdr,uint16_t DstAdr,uint16_t Cmd,uint8_t Len,uint8_t *pData);//485发送函数
