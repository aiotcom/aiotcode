...
{  
    ...
    switch(state)
    {
        ...
        case 2:
            ...
            {
                SetNFC_Blockmem = 0;
                Rs485_Send(Addr_LCD,Addr_NFC,NFC_Set_Memblock,16,BlockmemInputBuffer);//485总线请求NFC卡片ID
                printf("send\r\n");
                state     = 0;
                return;
            }
            ...
            {
                Rs485_Send(Addr_LCD,Addr_NFC,NFC_Get_All,0,(void*)0);//485总线请求NFC卡片ID
                state     = 3;
            }                
            break;
        case 3:
