...
#define			MatrixkeyKeyValue				0x12F2		//矩阵键盘-按键Right
...
#define			NFC_Get_All					0x3442		//NFC 获取全部数据
#define			NFC_Set_Memblock					0x3443		//NFC 获取全部数据
#define			HF_RFID_Set_Memblock					0x3444		//NFC 获取全部数据
/*
		定义485发送数据结构体
*/
typedef struct
