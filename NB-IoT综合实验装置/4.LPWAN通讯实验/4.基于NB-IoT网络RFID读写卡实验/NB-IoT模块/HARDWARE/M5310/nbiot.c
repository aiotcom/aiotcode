...
//***************************RFID**********************************************<<< 
    ...
    m5310_notify_upload(&rfid_uri,NBIOT_STRING,"5",0,0); 	//订阅资源    
//***************************RFID**********************************************>>>  
		delay_ms(1000);
}
