...
void LCD_UI(void)
{
	...
	LCD_ShowString(90,30,"R F I D",1);
	LCD_DrawRectangle(1,60,239,150);			//数据显示框
	LCD_ShowString(6,80,"I D :0x",1);
	LCD_ShowString(6,110,"Data:0x",1);
}
...
void TFT_Update(void)
{
	...
	{
		if(Rx_Stack.Src_Adr == Addr_NB)	//来自矩阵键盘的数据
		{
			for(i=0;i<4;i++)
			{
			...
			{
				LCD_ShowString(66,80,SendData,0);			
				LCD_ShowString(66,110,SendBuf,0);
			}
		}
	}
}
