...
*/
	...
	/*帧头2 数据帧头中第二个字节*/
	else if(Header_Flag == 1 && data == 0xE2)
	{
		Receive_Data[1] = data;
		Header_Flag = 2;
	}		
	...
	/*帧头3 数据帧头中第三个字节*/
	else if(Header_Flag == 2 && data == 0xE3)
	{
		Receive_Data[2] = data;
		Header_Flag = 3;
	}		
...
*/
	...
	{		
		...
		/*帧尾1 数据帧尾中第一个字节*/
		if(data == 0xEA)	End_Flag = 5;
		
		/*帧尾2  数据帧尾中第二个字节*/
		else if(End_Flag == 5 && data == 0xEB)	End_Flag = 6;

		/*帧尾3  数据帧尾中第三个字节*/
		else if(End_Flag == 6 && data == 0xEC)	End_Flag = 7;

		/*帧尾4  数据帧尾中第四个字节*/
		else if(End_Flag == 7 && data == 0xED)	
		{
...
//	说明：		
//==========================================================
uint8_t DataHand_485(uint8_t DesAddr)
{
	static uint16_t i = 0;
