...
void LCD_UI(void)
{
	...
	LCD_ShowString(20,30,"Transport",1);
	LCD_ShowString(20,170,"Receive",1);	
	LCD_DrawRectangle(2,50,238,140);			//数据显示框-Transport
	LCD_DrawRectangle(2,190,238,280);			//数据显示框-Receive
	LCD_ShowString(6,60,"Data:",1);
	LCD_ShowString(6,200,"Data:",1);
}
...
void TFT_Update(void)
{
	if(!DataHandling_485(Addr_LCD))			//接收数据
	{
			...
			{
				case LCD_Display:	//发送数据显示
					LCD_ShowString(45,60,Rx_Stack.Data,0);	
				break;
				case LED_Control:	//接收数据显示
					LCD_ShowString(45,200,Rx_Stack.Data,0);	
				break;
				default: break;
			}
