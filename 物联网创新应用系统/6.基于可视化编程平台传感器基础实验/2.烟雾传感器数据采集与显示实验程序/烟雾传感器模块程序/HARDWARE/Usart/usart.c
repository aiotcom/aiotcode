...
void Data_Conversion(void)
{
	...
	Smoke_V = Get_Adc_Average(ADC_CHANNEL_3,50);  		//获取烟雾浓度

	if(Smoke_V<2650)
	{
		Data_Smoke_WiFi[0] = 10;
	}
	else if(Smoke_V>=2650 && Smoke_V<2800)
	{
		Data_Smoke_WiFi[0] = 20;
	}
	else if(Smoke_V>=2800 && Smoke_V<2950)
	{
		Data_Smoke_WiFi[0] = 30;
	}
	else if(Smoke_V>=2950 && Smoke_V<3100)
	{
		Data_Smoke_WiFi[0] = 40;
	}
	else if(Smoke_V>=3100 && Smoke_V<3250)
	{
		Data_Smoke_WiFi[0] = 50;
	}
	else if(Smoke_V>=3250 && Smoke_V<3400)
	{
		Data_Smoke_WiFi[0] = 60;
	}
	else if(Smoke_V>=3400 && Smoke_V<3550)
	{
		Data_Smoke_WiFi[0] = 70;
	}
	else if(Smoke_V>=3550 && Smoke_V<3700)
	{
		Data_Smoke_WiFi[0] = 80;
	}
	else if(Smoke_V>=3700 && Smoke_V<3850)
	{
		Data_Smoke_WiFi[0] = 90;
	}
	else if(Smoke_V>=3850)
	{
		Data_Smoke_WiFi[0] = 99;
	}
}
