...
#define EN_USART0_RX   1
#define USART0_RECV_BUFFER_LENGTH 100	  

extern uint8_t USART0_RecvBuffer[ ];
extern uint16_t USART0_RecvIndex;

//如果想串口中断接收，请不要注释以下宏定义
extern void USRT0_Init(void);
extern void USART0_SendBytes(char *pdata,uint16_t lenght);
