...
static uint8_t ChannelNo;//通信的通道号 
...
void NRF24L01_RX_Mode(void)
{
    ...
    NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,ChannelNo);	    	//设置RF通信频率->0~0x7F		  
...
void NRF24L01_TX_Mode(void)
{
    ...
    NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,ChannelNo);       //设置RF通道为40->0~0x7F
    NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x26);  //设置TX发射参数,0db增益,250Kbps,低噪声增益开启   
