...
uint8_t LoraChReceiveRxLen = 0,loraChReceive=0,loraChReceiveBuffer[32];
uint8_t _24GChReceiveRxLen = 0,_24GChReceive=0,_24GChReceiveBuffer[32];
uint8_t zigBeeChReceiveRxLen = 0,zigBeeChReceive=0,zigBeeChReceiveBuffer[32];
...
int main(void)
{
    ...
    TIM3_Init(10000-1,640-1,RS485_HandlerCb);//10HZ 中断频率
    SPI_Enc28j60_Init();
...
#if TCP_Client_Test    
	uip_ipaddr(&ipaddr,192,168,3,3);	//设置IP为192.168.3.33 
