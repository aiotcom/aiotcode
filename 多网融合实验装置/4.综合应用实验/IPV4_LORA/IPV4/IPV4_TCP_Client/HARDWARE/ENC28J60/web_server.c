...
static unsigned char mymac[6] = {0x54,0x55,0x58,0x10,0x01,0x24};
...
unsigned int print_webpage(unsigned char *buf,unsigned char on_off)
{
    ...
    plen=fill_tcp_data_p(buf,plen,PSTR("</center><hr><br>****************^_^ 風語千年的以太网测试程序 ^_^****************\n"));
...
{   
  ...
  enc28j60PhyWrite(PHLCON,0x476);//显示链接状态 显示发送和接收活动 	
