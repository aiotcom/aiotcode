...
#define PA1_GPIO_NBR                  6
unsigned int *PA1_MUX;
unsigned int *PA1_GPIO_GDIR;
unsigned int *PA1_GPIO_DR;
unsigned int *PA1_GPIO_PAD;
#define PA0_GPIO_NBR                  12
unsigned int *PA0_MUX;
unsigned int *PA0_GPIO_GDIR;
unsigned int *PA0_GPIO_DR;
...
{
	PA1_MUX          =   (unsigned int*)ioremap(0x20e0234,4);
	PA1_GPIO_GDIR    =   (unsigned int*)ioremap(0x209C004,4);
	PA1_GPIO_DR      =   (unsigned int*)ioremap(0x209C000,4);
	PA1_GPIO_PAD     =   (unsigned int*)ioremap(0x20E0604,4);
	
	PA0_MUX         = 	(unsigned int*)ioremap(0x20e0250,4);
	PA0_GPIO_GDIR   = 	(unsigned int*)ioremap(0x20a8004,4);
	PA0_GPIO_DR     = 	(unsigned int*)ioremap(0x20a8000,4);

	imx6_gpio_mode(PA0_MUX);
	imx6_gpio_mode(PA1_MUX);	
	
	imx6_gpio_in(PA1_GPIO_GDIR,PA1_GPIO_NBR);//MISO
	imx6_gpio_pupd(PA1_GPIO_PAD,PD_100K_OHM);
		
	imx6_gpio_out(PA0_GPIO_GDIR,PA0_GPIO_NBR);//CS	

	imx6_gpio_write(PA0_GPIO_DR,PA0_GPIO_NBR,0);	
}
/*************************************************/
...
static int key_read(struct file *filp, char __user *buff,size_t count, loff_t *offp)
{
	...
	byte = imx6_gpio_read(PA1_GPIO_DR,PA1_GPIO_NBR);
