...
uint8_t Atmosphere_TestFunc(void)
{
    ...
    sprintf((char *)Temp_Data,"Temp:%0.3fC ",temp_act);   //数据转换  
    sprintf((char *)Pres_Data,"Pres:%0.3fPa ",press_act); //数据转换
    sprintf((char *)Hum_Data,"Humi:%0.3f ",hum_act);       //数据转换
