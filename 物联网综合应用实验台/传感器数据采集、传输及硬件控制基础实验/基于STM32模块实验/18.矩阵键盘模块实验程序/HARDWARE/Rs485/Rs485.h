...
/*		模式控制		*/ 
#define RS485_TX_EN()		 HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8,GPIO_PIN_SET)		//485发送模式
#define RS485_RX_EN()		 HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8,GPIO_PIN_RESET)	//485接收模式
...
extern void Rs485_delay_ms(unsigned int nms);
extern void Rs485_Send(uint8_t *pData,uint8_t Len);//485发送函数
