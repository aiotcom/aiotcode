...
void mlx_gpio_init(void)
{
    ...
    GPIO_InitStructure.Pin =  mlx_SCL_PIN | mlx_SDA_PIN;
    GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(mlx_I2C_PORT, &GPIO_InitStructure);
...
void mlx_SCL_OUTPUT(void)
{
    ...
    GPIO_InitStructure.Pin =  mlx_SCL_PIN;
    GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(mlx_I2C_PORT, &GPIO_InitStructure);
}
...
void mlx_SDA_OUT(void)
{
    ...
    GPIO_InitStructure.Pin =  mlx_SDA_PIN;
...
void SendRequest(void)
{
	...
	delay_ms(100);			// 	  0	            |__________________|
	mlx_SCL_HIGH();
}
