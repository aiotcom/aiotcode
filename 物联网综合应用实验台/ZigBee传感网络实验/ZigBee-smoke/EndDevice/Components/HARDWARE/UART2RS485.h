...
#define         Get_PIR_Sta                      0x1700  //获取人体红外感应传感器状态
#define         PIR_Sta        0x1701  //人体红外感应传感器状态
#define         Get_Smoke_Sta     0x1800  //获取传感器状态
#define        Smoke_Sta       0x1801  //烟雾传感器状态
