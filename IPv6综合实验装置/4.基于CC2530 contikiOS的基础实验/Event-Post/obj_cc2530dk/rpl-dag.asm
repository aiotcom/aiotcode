...
_default_instance::
	.ds 3
_rpl_find_parent_any_dag_p_65536_608:
	.ds 3
_rpl_find_parent_any_dag_dag_65536_608:
	.ds 3
_rpl_find_parent_any_dag_end_65536_608:
	.ds 3
_rpl_select_dag_last_parent_65536_616:
	.ds 3
_rpl_select_dag_dag_65536_616:
	.ds 3
_rpl_select_dag_end_65536_616:
	.ds 3
_rpl_select_dag_best_dag_65536_616:
	.ds 3
_rpl_select_dag_old_rank_65536_616:
	.ds 2
;--------------------------------------------------------
...
;instance                  Allocated to registers r5 r6 r7 
;p                         Allocated with name '_rpl_find_parent_any_dag_p_65536_608'
;dag                       Allocated with name '_rpl_find_parent_any_dag_dag_65536_608'
;end                       Allocated with name '_rpl_find_parent_any_dag_end_65536_608'
;------------------------------------------------------------
...
;	../../../core/net/rpl/rpl-dag.c:552: for(dag = &instance->dag_table[0], end = dag + RPL_MAX_DAG_PER_INSTANCE; dag < end; ++dag) {
	...
	addc	a,r6
	mov	r6,a
	mov	dptr,#_rpl_find_parent_any_dag_dag_65536_608
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
	mov	dptr,#_rpl_find_parent_any_dag_end_65536_608
	mov	a,#0x76
	add	a,r5
	movx	@dptr,a
	clr	a
...
;	../../../core/net/rpl/rpl-dag.c:554: for(p = list_head(dag->parents); p != NULL; p = p->next) {
	...
	mov	r6,dph
	mov	r7,b
	mov	dptr,#_rpl_find_parent_any_dag_p_65536_608
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;instance                  Allocated to stack - sp -5
;sloc0                     Allocated to stack - sp -2
;last_parent               Allocated with name '_rpl_select_dag_last_parent_65536_616'
;dag                       Allocated with name '_rpl_select_dag_dag_65536_616'
;end                       Allocated with name '_rpl_select_dag_end_65536_616'
;best_dag                  Allocated with name '_rpl_select_dag_best_dag_65536_616'
;old_rank                  Allocated with name '_rpl_select_dag_old_rank_65536_616'
;------------------------------------------------------------
...
;	../../../core/net/rpl/rpl-dag.c:571: old_rank = instance->current_dag->rank;
	...
	lcall	__gptrget
	mov	r6,a
	mov	dptr,#_rpl_select_dag_old_rank_65536_616
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	../../../core/net/rpl/rpl-dag.c:572: last_parent = instance->current_dag->preferred_parent;
	...
	lcall	__gptrget
	mov	r7,a
	mov	dptr,#_rpl_select_dag_last_parent_65536_616
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	../../../core/net/rpl/rpl-dag.c:574: best_dag = instance->current_dag;
	...
	lcall	__gptrget
	mov	r4,a
	mov	dptr,#_rpl_select_dag_best_dag_65536_616
	mov	a,r2
	movx	@dptr,a
	mov	a,r3
	inc	dptr
...
;	../../../core/net/rpl/rpl-dag.c:582: for(dag = &instance->dag_table[0], end = dag + RPL_MAX_DAG_PER_INSTANCE; dag < end; ++dag) {
	...
	inc	r0
	mov	ar7,@r0
	mov	dptr,#_rpl_select_dag_dag_65536_616
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
	mov	dptr,#_rpl_select_dag_end_65536_616
	mov	a,#0x76
	add	a,r5
	movx	@dptr,a
	clr	a
