...
#define LORA_RST       P1_1
#define KEY_INPUT      P0_3
#define LED_SET        P0_2
...
#define	SX1278_CS_L()       SPI_NSS = 0   	
#define	SX1278_CS_H()       SPI_NSS = 1    

#define	SX1278_RST_H()      LORA_RST = 1     
#define	SX1278_RST_L()      LORA_RST = 0     
#define SX1278_IRQ_INPUT()  
