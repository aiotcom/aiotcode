...
{
    P0SEL &= ~0x04;     //设置P0.2为普通IO口  
    P0DIR |= 0x04;      //P0.2定义为输出
}
...
{
    P0SEL &= ~0x04;     //设置P0.2为普通IO口  
    P0DIR &= ~0x04;     //设P0.2为输入模式 
    P0INP &= ~0x04;     //打开P0.2上拉电阻
}
...
{
    P0SEL &= ~0x08;     //设置P0.3为普通IO口  
    P0DIR &= ~0x08;     //设P0.3为输入模式 
    P0INP &= ~0x08;     //打开P0.3上拉电阻
}
