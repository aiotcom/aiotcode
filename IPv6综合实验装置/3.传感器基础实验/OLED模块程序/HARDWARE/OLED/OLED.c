...
uint8_t KEY_Scan(uint8_t mode)
{
    ...
    if(key_up&&(KEY_Read()==0))
    {
        delay_ms(10);
        key_up=0;
        if(KEY_Read()==0)       return KEY_PRES;

    }else if(KEY_Read()==1)key_up=1;
...
//	说明：		
//==========================================================
unsigned char OLED_Key_Read(void)
{
...
void OLED_Init(void)
{
    ...
    P1SEL &= ~0x40;     //设置P1.6为普通IO口  
    P1DIR &= ~0x40;     //按键接在P1.6口上，设P1.6为输入模式 
    P1INP &= ~0x40;     //打开P1.6拉电阻
