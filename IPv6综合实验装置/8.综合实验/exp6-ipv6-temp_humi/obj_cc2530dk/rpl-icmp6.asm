...
_dao_sender_addr:
	.ds 16
_dis_output_tmpaddr_65536_308:
	.ds 16
_dio_output_pos_65536_332:
	.ds 2
_dao_input_sequence_65536_344:
	.ds 2
_dao_input_instance_id_65536_344:
	.ds 1
_dao_input_lifetime_65536_344:
	.ds 1
_dao_input_prefixlen_65536_344:
	.ds 1
_dao_input_buffer_length_65536_344:
	.ds 1
_dao_input_pos_65536_344:
	.ds 2
;--------------------------------------------------------
...
;tmpaddr                   Allocated with name '_dis_output_tmpaddr_65536_308'
;------------------------------------------------------------
...
;	../../../core/net/rpl/rpl-icmp6.c:198: uip_create_linklocal_rplnodes_mcast(&tmpaddr);
	mov	dptr,#_dis_output_tmpaddr_65536_308
	mov	a,#0xff
	movx	@dptr,a
	mov	a,#0x02
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x0002)
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x0004)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x0006)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x0008)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x000a)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x000c)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_dis_output_tmpaddr_65536_308 + 0x000e)
	movx	@dptr,a
	mov	a,#0x1a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/rpl/rpl-icmp6.c:199: addr = &tmpaddr;
	...
	dec	r0
	dec	r0
	mov	@r0,#_dis_output_tmpaddr_65536_308
	inc	r0
	mov	@r0,#(_dis_output_tmpaddr_65536_308 >> 8)
	inc	r0
	mov	@r0,#0x00
00105$:
...
;pos                       Allocated with name '_dio_output_pos_65536_332'
;------------------------------------------------------------
...
;	../../../core/net/rpl/rpl-icmp6.c:428: buffer[pos++] = instance->instance_id;
	mov	dptr,#_dio_output_pos_65536_332
	mov	a,#0x01
	movx	@dptr,a
	clr	a
	inc	dptr
...
;sequence                  Allocated with name '_dao_input_sequence_65536_344'
;instance_id               Allocated with name '_dao_input_instance_id_65536_344'
;lifetime                  Allocated with name '_dao_input_lifetime_65536_344'
;prefixlen                 Allocated with name '_dao_input_prefixlen_65536_344'
;buffer_length             Allocated with name '_dao_input_buffer_length_65536_344'
;pos                       Allocated with name '_dao_input_pos_65536_344'
;------------------------------------------------------------
...
;	../../../core/net/rpl/rpl-icmp6.c:571: prefixlen = 0;
	mov	dptr,#_dao_input_prefixlen_65536_344
	clr	a
	movx	@dptr,a
...
;	../../../core/net/rpl/rpl-icmp6.c:581: buffer_length = uip_len - uip_l3_icmp_hdr_len;
	...
	add	a,r7
	mov	r7,a
	mov	dptr,#_dao_input_buffer_length_65536_344
	mov	a,r2
	clr	c
	subb	a,r7
	movx	@dptr,a
;	../../../core/net/rpl/rpl-icmp6.c:584: instance_id = buffer[pos++];
	mov	dptr,#_dao_input_pos_65536_344
	mov	a,#0x01
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	lcall	__gptrget
	mov	r7,a
	mov	dptr,#_dao_input_instance_id_65536_344
	movx	@dptr,a
...
;	../../../core/net/rpl/rpl-icmp6.c:593: lifetime = instance->default_lifetime;
	...
	mov	b,r7
	lcall	__gptrget
	mov	dptr,#_dao_input_lifetime_65536_344
	movx	@dptr,a
...
;	../../../core/net/rpl/rpl-icmp6.c:598: sequence = buffer[pos++];
	...
	mov	b,r7
	lcall	__gptrget
	mov	dptr,#_dao_input_sequence_65536_344
	movx	@dptr,a
	clr	a
	inc	dptr
	movx	@dptr,a
