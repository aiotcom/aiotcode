...
;got_strobe_ack            Allocated to stack - sp -64
;got_ack                   Allocated to stack - sp -63
;strobe                    Allocated to stack - sp -62
;strobe_len                Allocated to stack - sp -12
;len                       Allocated to registers r2 r4 
;is_broadcast              Allocated to stack - sp -10
;e                         Allocated to stack - sp -8
;packet                    Allocated to stack - sp -5
;is_already_streaming      Allocated to stack - sp -2
;collisions                Allocated to stack - sp +0
...
;sloc0                     Allocated to stack - sp -70
;sloc1                     Allocated to stack - sp -67
;sloc2                     Allocated to stack - sp -66
;------------------------------------------------------------
