...
_outputfunc:
	.ds 3
_tcp_unlisten_i_65536_545:
	.ds 1
_tcp_listen_i_65536_550:
	.ds 1
_eventhandler_i_65536_572:
	.ds 1
_eventhandler_p_65536_572:
	.ds 3
_tcpip_ipv6_output_nbr_65536_599:
	.ds 3
_tcpip_ipv6_output_nexthop_65536_599:
	.ds 3
_tcpip_uipcall_ts_65536_623:
	.ds 3
_tcpip_uipcall_i_131072_626:
	.ds 1
_process_thread_tcpip_process_i_262144_637:
	.ds 1
;--------------------------------------------------------
...
;nbr                       Allocated with name '_tcpip_ipv6_output_nbr_65536_599'
;nexthop                   Allocated with name '_tcpip_ipv6_output_nexthop_65536_599'
;------------------------------------------------------------
;	../../../core/net/tcpip.c:549: static uip_ds6_nbr_t *nbr = NULL;
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_599
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;i                         Allocated with name '_tcp_unlisten_i_65536_545'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:254: for(i = 0; i < UIP_LISTENPORTS; ++i) {
	mov	dptr,#_tcp_unlisten_i_65536_545
	clr	a
	movx	@dptr,a
	mov	r0,sp
	dec	r0
...
;i                         Allocated with name '_tcp_listen_i_65536_550'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:272: for(i = 0; i < UIP_LISTENPORTS; ++i) {
	mov	dptr,#_tcp_listen_i_65536_550
	clr	a
	movx	@dptr,a
	mov	r0,sp
	dec	r0
...
;------------------------------------------------------------
;	../../../core/net/tcpip.c:347: icmp6_new(void *appstate) {
;	-----------------------------------------
;	 function icmp6_new
;	-----------------------------------------
_icmp6_new:
	...
	mov	r6,dph
	mov	r7,b
;	../../../core/net/tcpip.c:348: if(uip_icmp6_conns.appstate.p == PROCESS_NONE) {
	...
	orl	a,r3
	jnz	00102$
;	../../../core/net/tcpip.c:349: uip_icmp6_conns.appstate.p = PROCESS_CURRENT();
	mov	dptr,#_process_current
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:350: uip_icmp6_conns.appstate.state = appstate;
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:351: return 0;
	mov	dpl,#0x00
	sjmp	00103$
00102$:
;	../../../core/net/tcpip.c:353: return 1;
	mov	dpl,#0x01
00103$:
;	../../../core/net/tcpip.c:354: }
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../../core/net/tcpip.c:357: tcpip_icmp6_call(uint8_t type)
;	-----------------------------------------
;	 function tcpip_icmp6_call
;	-----------------------------------------
_tcpip_icmp6_call:
	push	dpl
;	../../../core/net/tcpip.c:359: if(uip_icmp6_conns.appstate.p != PROCESS_NONE) {
	mov	dptr,#_uip_icmp6_conns
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	orl	a,r6
	jz	00102$
;	../../../core/net/tcpip.c:362: process_post_synch(uip_icmp6_conns.appstate.p, tcpip_icmp6_event, &type);
	mov	r7,sp
	mov	r6,#0x00
	mov	r5,#0x40
	mov	dptr,#_uip_icmp6_conns
	...
	mov	sp,a
00102$:
;	../../../core/net/tcpip.c:364: return;
;	../../../core/net/tcpip.c:365: }
	dec	sp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;cptr                      Allocated to registers 
;i                         Allocated with name '_eventhandler_i_65536_572'
;p                         Allocated with name '_eventhandler_p_65536_572'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:384: p = (struct process *)data;
	...
	add	a,#0xfb
	mov	r0,a
	mov	dptr,#_eventhandler_p_65536_572
	mov	a,@r0
	movx	@dptr,a
	inc	r0
	mov	a,@r0
...
;	../../../core/net/tcpip.c:387: for(i = 0; i < UIP_LISTENPORTS; ++i) {
	mov	dptr,#_eventhandler_i_65536_572
	clr	a
	movx	@dptr,a
00138$:
...
;	../../../core/net/tcpip.c:572: nexthop = &UIP_IP_BUF->destipaddr;
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_599
...
;ts                        Allocated with name '_tcpip_uipcall_ts_65536_623'
;i                         Allocated with name '_tcpip_uipcall_i_131072_626'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:713: ts = &uip_conn->appstate;
	...
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_tcpip_uipcall_ts_65536_623
	mov	a,#0x28
	add	a,r5
	movx	@dptr,a
	clr	a
...
;	../../../core/net/tcpip.c:730: for(i = 0; i < UIP_LISTENPORTS; ++i) {
	mov	dptr,#_tcpip_uipcall_i_131072_626
	clr	a
	movx	@dptr,a
	mov	r0,sp
	dec	r0
...
;i                         Allocated with name '_process_thread_tcpip_process_i_262144_637'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:768: for(i = 0; i < UIP_LISTENPORTS; ++i) {
	mov	dptr,#_process_thread_tcpip_process_i_262144_637
	clr	a
	movx	@dptr,a
00113$:
...
;	../../../core/net/tcpip.c:775: tcpip_event = process_alloc_event();
	...
	mov	dptr,#_tcpip_event
	movx	@dptr,a
;	../../../core/net/tcpip.c:777: tcpip_icmp6_event = process_alloc_event();
	mov	r0,#_process_alloc_event
	mov	r1,#(_process_alloc_event >> 8)
	mov	r2,#(_process_alloc_event >> 16)
	lcall	__sdcc_banked_call
