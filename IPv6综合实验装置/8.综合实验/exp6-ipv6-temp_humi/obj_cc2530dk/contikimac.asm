...
;encounter_time            Allocated to stack - sp -14
...
;is_known_receiver         Allocated to stack - sp -10
;collisions                Allocated to stack - sp -9
;transmit_len              Allocated to stack - sp -8
;ret                       Allocated to registers r6 r7 
;contikimac_was_on         Allocated to stack - sp -6
