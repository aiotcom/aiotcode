...
_TM1640_Init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	../../../platform/cc2530dk/SHT20/TM1640.c:10: P1SEL &= ~0x30;     //设置P1.4、P1.5为普通IO口  
	anl	_P1SEL,#0xcf
;	../../../platform/cc2530dk/SHT20/TM1640.c:11: P1DIR |= 0x30;      //P1.4、P1.5定义为输出
	orl	_P1DIR,#0x30
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:13: LED_DisplayClear();//清楚显示
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:120: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:121: write(SET_DATA_ORDER);//设置数据，0x40,0x44分别对应地址自动加一和固定地址模式
	mov	dpl,#0x40
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:123: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:124: write(SET_DISPLAY);	  //控制显示，开显示0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f分别对应脉冲宽度
	mov	dpl,#0x8c
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:148: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:149: write(SET_DATA_ORDER);	//设置数据，0x40,0x44分别对应地址自动加一和固定地址模式
	mov	dpl,#0x40
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:152: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:153: write(0x00);		//设置地址
	mov	dpl,#0x00
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:160: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:161: write(SET_DISPLAY);	       //控制显示，开显示0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f分别对应脉冲宽度
	mov	dpl,#0x8c
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
_send_LED_Display:
	inc	sp
	mov	r7,dpl
;	../../../platform/cc2530dk/SHT20/TM1640.c:182: if(type == 1)//显示温度的数据
	mov	a,sp
	add	a,#0xfa
	mov	r0,a
	cjne	@r0,#0x01,00110$
;	../../../platform/cc2530dk/SHT20/TM1640.c:184: SEG_4 = 11;
	...
	sjmp	00111$
00110$:
;	../../../platform/cc2530dk/SHT20/TM1640.c:186: else if(type == 2)//显示湿度的数据
	mov	a,sp
	add	a,#0xfa
	mov	r0,a
	cjne	@r0,#0x02,00107$
;	../../../platform/cc2530dk/SHT20/TM1640.c:188: SEG_4 = 12;
	...
	sjmp	00111$
00107$:
;	../../../platform/cc2530dk/SHT20/TM1640.c:190: else if(type == 3)//显示光强的数据
	mov	a,sp
	add	a,#0xfa
	mov	r0,a
	cjne	@r0,#0x03,00104$
;	../../../platform/cc2530dk/SHT20/TM1640.c:192: SEG_4 = data%10;
	...
	sjmp	00111$
00104$:
;	../../../platform/cc2530dk/SHT20/TM1640.c:194: else if(type == 4)//配合其他模块显示
	mov	a,sp
	add	a,#0xfa
	mov	r0,a
	cjne	@r0,#0x04,00111$
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:223: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:224: write(SET_DATA_ORDER);	//设置数据，0x40,0x44分别对应地址自动加一和固定地址模式
	mov	dpl,#0x40
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:227: start();
	...
	pop	ar6
	pop	ar7
;	../../../platform/cc2530dk/SHT20/TM1640.c:228: write(address);	//设置起始地址
	mov	dpl,r7
	push	ar6
	push	ar4
	push	ar3
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:236: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:237: write(SET_DISPLAY);	//控制显示，开显示0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f分别对应脉冲宽度
	mov	dpl,#0x8c
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:260: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:261: write(SET_DATA_ORDER);	//设置数据，0x40,0x44分别对应地址自动加一和固定地址模式
	mov	dpl,#0x40
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:264: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:265: write(0xc0);	//设置起始地址
	mov	dpl,#0xc0
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:273: start();
	...
	mov	r2,#(_start >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:274: write(SET_DISPLAY);	//控制显示，开显示0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f分别对应脉冲宽度
	mov	dpl,#0x8c
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:284: start();
	...
	lcall	__sdcc_banked_call
	pop	ar7
;	../../../platform/cc2530dk/SHT20/TM1640.c:285: write(address);	//设置起始地址
	mov	dpl,r7
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
...
;	../../../platform/cc2530dk/SHT20/TM1640.c:298: start();
	...
	lcall	__sdcc_banked_call
	pop	ar7
;	../../../platform/cc2530dk/SHT20/TM1640.c:299: write(address);	//传显示数据对应地址
	mov	dpl,r7
	mov	r0,#_write
	mov	r1,#(_write >> 8)
	mov	r2,#(_write >> 16)
	lcall	__sdcc_banked_call
;	../../../platform/cc2530dk/SHT20/TM1640.c:300: write(date);	//传BYTE显示数据
	mov	a,sp
	add	a,#0xfd
	mov	r0,a
	mov	dpl,@r0
